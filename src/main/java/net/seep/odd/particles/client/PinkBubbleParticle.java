// src/main/java/net/seep/odd/particles/client/PinkBubbleParticle.java
...
public class PinkBubbleParticle extends SpriteBillboardParticle {

    private final float baseR = 1.00f;
    private final float baseG = 0.45f;
    private final float baseB = 0.82f;

    private final float pulseAmp = 0.10f;
    private final float pulseSpeed = 0.34f;
    private final float pulseJitter;

    protected PinkBubbleParticle(ClientWorld world, double x, double y, double z,
    ...
    public void tick() {
        ...
        float b = MathHelper.clamp(baseB + swing * 0.03f, 0f, 1f);
        this.setColor(r, g, b);
    }
    ...
    public static class Factory implements ParticleFactory<DefaultParticleType> {
        ...
        public Particle createParticle(DefaultParticleType type, ClientWorld w, double x, double y, double z,
                                       double vx, double vy, double vz) {
            PinkBubbleParticle p = new PinkBubbleParticle(w, x, y, z, vx, vy, vz);
