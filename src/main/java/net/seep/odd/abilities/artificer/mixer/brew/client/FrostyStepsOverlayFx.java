// FILE: src/main/java/net/seep/odd/abilities/artificer/mixer/brew/client/FrostyStepsOverlayFx.java
...
public final class FrostyStepsOverlayFx {
    private FrostyStepsOverlayFx() {}
    ...
    public static void init() {
        ...
        effect = ShaderEffectManager.getInstance().manage(new Identifier("odd", "shaders/post/frosty_steps.json"));
