...
public class TameBallModel extends GeoModel<TameBallEntity> {
    @Override
    public Identifier getModelResource(TameBallEntity animatable) {
        return new Identifier(Oddities.MOD_ID, "geo/tame_ball.geo.json");
    }

    @Override
    public Identifier getTextureResource(TameBallEntity animatable) {
        return new Identifier(Oddities.MOD_ID, "textures/entity/tame_ball.png");
    }

    @Override
    public Identifier getAnimationResource(TameBallEntity animatable) {
        // If you have no animations, create a tiny empty file:
        // assets/odd/animations/tame_ball.animation.json with {} animations map.
