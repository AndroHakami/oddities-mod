...
public class TameBallItemModel extends GeoModel<TameBallItem> {
    @Override public Identifier getModelResource(TameBallItem animatable) {
        return new Identifier(Oddities.MOD_ID, "geo/tame_ball.geo.json");
    }
    @Override public Identifier getTextureResource(TameBallItem animatable) {
        return new Identifier(Oddities.MOD_ID, "textures/item/tame_ball.png");
    }
    @Override public Identifier getAnimationResource(TameBallItem animatable) {
        return new Identifier(Oddities.MOD_ID, "animations/tame_ball.animation.json"); // or point to a blank file
    }
}
