...
public class IceProjectileRenderer extends EntityRenderer<IceProjectileEntity> {
    ...
    private static final ItemStack RENDER_STACK = new ItemStack(ModItems.ICE_PROJECTILE);

    public IceProjectileRenderer(EntityRendererFactory.Context ctx) {
        super(ctx);
    ...
    @Override
    public void render(IceProjectileEntity entity, float yaw, float tickDelta,
