// FILE: src/main/java/net/seep/odd/abilities/sniper/client/render/SniperGrappleShotRenderer.java
...
public final class SniperGrappleShotRenderer extends EntityRenderer<SniperGrappleShotEntity> {

    private static final Identifier DUMMY = new Identifier("minecraft", "textures/entity/lead.png");

    public SniperGrappleShotRenderer(EntityRendererFactory.Context ctx) {
        super(ctx);
        this.shadowRadius = 0.0f;
    }

    @Override
    public boolean shouldRender(SniperGrappleShotEntity entity, Frustum frustum, double x, double y, double z) {
        return true; // keep cable consistent while shot exists
    }

    @Override
    public void render(SniperGrappleShotEntity entity, float yaw, float tickDelta,
    ...
    @Override
    public Identifier getTexture(SniperGrappleShotEntity entity) {
        return DUMMY;
    }
}
