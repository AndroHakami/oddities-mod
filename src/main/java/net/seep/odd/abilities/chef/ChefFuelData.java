// src/main/java/net/seep/odd/abilities/chef/ChefFuelData.java
...
public class ChefFuelData extends PersistentState {
    private static final String KEY = "odd_chef_fuel";
    public static final int SIZE = 1;

    private final Map<UUID, DefaultedList<ItemStack>> byPlayer = new HashMap<>();

    public static ChefFuelData get(ServerWorld world) {
        return world.getPersistentStateManager().getOrCreate(
                ChefFuelData::fromNbt,
                ChefFuelData::new,
                KEY
        );
    }
    ...
    public static ChefFuelData fromNbt(NbtCompound nbt) {
        ChefFuelData d = new ChefFuelData();
