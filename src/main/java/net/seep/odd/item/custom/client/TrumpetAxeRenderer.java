// FILE: src/main/java/net/seep/odd/item/client/TrumpetAxeRenderer.java
...
public class TrumpetAxeRenderer extends GeoItemRenderer<TrumpetAxeItem> {
    public TrumpetAxeRenderer() {
        super(new TrumpetAxeModel());
    ...
    // pulled even closer to the player
