...
public class ModItems {
    ...
    public static final Item SNIPER = Registry.register(Registries.ITEM, new Identifier(Oddities.MOD_ID, "sniper"), new SniperItem(new Item.Settings().maxCount(1)));
    ...
    public static final Item WALKING_STICK =
            registerItem("walking_stick", new WalkingStickItem(new FabricItemSettings().maxCount(1)));
    public static final Item WIZARD_FIRE_PROJECTILE_ITEM =
            registerItem("wizard_fire_projectile", new Item(new FabricItemSettings()));
    public static final Item WIZARD_WATER_PROJECTILE_ITEM =
            registerItem("wizard_water_projectile", new Item(new FabricItemSettings()));
    public static final Item WIZARD_EARTH_PROJECTILE_ITEM =
            registerItem("wizard_earth_projectile", new Item(new FabricItemSettings()));
    ...
    // ✅ CHEF: Mush (bad cooking result)

    public static final Item MUSH =
            registerItem("mush", new TooltipItem(new FabricItemSettings().food(ModFoodComponents.MUSH)));
    public static final Item CRAPPY_BURGER =
            registerItem("crappy_burger", new TooltipItem(new FabricItemSettings().food(ModFoodComponents.CRAPPY_BURGER)));
    ...
    private static void addItemsToIngredientItemGroup(FabricItemGroupEntries entries) {
        ...
        // ✅ Add mush so it’s visible in the creative tab for testing
        entries.add(MUSH);
    }
