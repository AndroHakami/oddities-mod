...
public final class Expeditions {
    ...
    public static void register() {
        // Register chunk generator codec under type "odd:rotten_roots"
        Registry.register(Registries.CHUNK_GENERATOR, ROTTEN_ROOTS_ID, RottenRootsChunkGenerator.CODEC.codec());
